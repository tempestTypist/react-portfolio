  ...
  return (
    <section 
      ...
      <motion.div 
        ...
        initial="hidden"
        animate={control}>
        <motion.img src={pfp} alt="Summer's Profile Picture" className="about-image" variants={itemA} />
        <motion.div className="" variants={itemA}>
      ...
      <motion.div 
        ...
        initial="hidden"
        animate={control}>
        <motion.div className="my-4" variants={itemB}>
          <div className="card">
            <ul className="list-group list-group-flush">
              <li className="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                ...
                <span className="text-secondary"><a href="https://tempest-portfolio.herokuapp.com/">tempest-portfolio</a></span>
              </li>
              <li className="list-group-item d-flex justify-content-between align-items-center flex-wrap">
